...
def DrawGLScene():
    ...
    global box,eyeX,eyeY,eyeZ,tori,ecube,sphere,SHAPE, num,number,drawType, time_between_frames, refresh_time,MODE
...
def keyPressed(key, x, y):
    global number,eyeX,eyeY,eyeZ,angle_h,angle_v,distance,SHAPE,MOUSEACTIVE,window,drawType,MODE
