...
prim = Primitive3D([square1])
shapes = prim.sub_division_v2(3)



vert = prim.divideXY(3,-2,-2,vec3d(3,3,3,1))

shapes = prim.subdivideShapes(2)


for i in range(len(prim.shapes)):
    print(prim.shapes[i].vertices[0].x,' ',prim.shapes[i].vertices[0].y,' ',prim.shapes[i].vertices[0].z)
    print(prim.shapes[i].vertices[1].x,' ',prim.shapes[i].vertices[1].y,' ',prim.shapes[i].vertices[1].z)
    print(prim.shapes[i].vertices[2].x,' ',prim.shapes[i].vertices[2].y,' ',prim.shapes[i].vertices[2].z)
    print(prim.shapes[i].vertices[3].x,' ',prim.shapes[i].vertices[3].y,' ',prim.shapes[i].vertices[3].z)
    print("---")
